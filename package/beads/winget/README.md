...
```powershell
winget install SteveYegge.beans
```

## Manifest Files

- `SteveYegge.beans.yaml` - Version manifest (main file)
- `SteveYegge.beans.installer.yaml` - Installer configuration
- `SteveYegge.beans.locale.en-US.yaml` - Package description and metadata
...
```powershell
wingetcreate update SteveYegge.beans --version <new-version> --urls <new-url> --submit
```
