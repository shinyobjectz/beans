...
Labels are automatically synced to `.beans/issues.jsonl` along with all issue data:
...
Labels are included in `.beans/issues.jsonl` export. If labels seem out of sync:
```bash
# Force export
