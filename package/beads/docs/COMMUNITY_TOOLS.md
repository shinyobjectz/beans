...
- **[Beadster](https://github.com/beadster/beadster)** - macOS app for browsing and managing issues from `.beans/` directories in git repositories. Built by [@podviaznikov](https://github.com/podviaznikov). (Swift)
