...
- **Custom**: Stored in `.beans/templates/` directory
...
Create a custom template in `.beans/templates/` directory.
...
✓ Created template: .beans/templates/performance.yaml
Edit the file to customize your template.

$ cat .beans/templates/performance.yaml
name: performance
description: |-
    [Describe the issue]
...
$ vim .beans/templates/performance.yaml
```
...
**Priority:**
1. Custom templates in `.beans/templates/`
...
$ cat > .beans/templates/bug.yaml << 'EOF'
name: bug
description: |
  ## Bug Report
...
3. **Version control templates**: Commit `.beans/templates/` to share across team
