...
- SQLite databases (`.beans/*.db`) - local only, gitignored
- JSONL files (`.beans/issues.jsonl`) - committed to git
...
2. **Review before export** - Check `.beans/issues.jsonl` before committing sensitive project details
