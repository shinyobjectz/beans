...
// The repo is initialized with git config, a .beans directory, and an initial commit.
...
func setupGitRepo(t *testing.T) (repoPath string, cleanup func()) {
	...
	// Create .beans directory with minimal issues.jsonl (required for RepoContext)
