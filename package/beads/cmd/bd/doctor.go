...
func runDiagnostics(path string) doctorResult {
	...
	// Check 1: Installation (.beans/ directory)
	...
	// Check Git Hooks early (even if .beans/ doesn't exist yet)
	...
	// If no .beans/, skip remaining checks
	if installCheck.Status != statusOK {
		return result
	}
	...
	// Check 20: Untracked .beans/*.jsonl files
