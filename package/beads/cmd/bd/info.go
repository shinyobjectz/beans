...
var versionChanges = []VersionChange{
	...
	},
	{
		...
		Changes: []string{
			...
			"FIX: Sync with redirect - Handle .beans/redirect in git status and import",
	...
	},
	{
		...
		Changes: []string{
			...
			"FIX: .beans/redirect not committed - Prevents worktree conflicts (GH#814)",
			...
			"FIX: MCP plugin follows .beans/redirect files",
	...
	},
	{
		...
		Changes: []string{
			...
			"FIX: bd sync commits non-.beans files - Now only commits .beans/ directory",
	...
	},
	{
		...
		Changes: []string{
			...
			"BREAKING: bd repo add/remove now writes to .beans/config.yaml (not DB)",
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: Agent audit trail - .beans/interactions.jsonl with bd audit record/label",
	...
	},
	{
		...
		Changes: []string{
			...
			"Enhanced Git Worktree Support - Shared .beans database across worktrees",
		},
	},
	{
		Version: "0.30.0",
	...
	},
	{
		...
		Changes: []string{
			...
			"sync.branch workflow fixes - Fixed .beans/ restoration and doctor detection",
	...
	},
	{
		...
		Date:    "2025-11-29",
		Changes: []string{
			"Git hooks now sync.branch aware - pre-commit/pre-push skip .beans checks when sync.branch configured",
	...
	},
	{
		...
		Changes: []string{
			...
			"bd sync Commit Scope Fixed - Only commits .beans/ files, not other staged files",
		},
	},
	{
		Version: "0.25.1",
		...
		Changes: []string{
			...
			"bd sync commit scope fixed - Now commits entire .beans/ directory before pull",
	...
	},
	{
		...
		Changes: []string{
			...
			".beans/README.md Generation - Auto-generated during bd init",
