...
// CheckMergeArtifacts detects temporary git merge files in .beans directory.
...
func CheckMergeArtifacts(path string) DoctorCheck {
	...
	// Read patterns from .beans/.gitignore (merge artifacts section)
...
// readMergeArtifactPatterns reads patterns from .beans/.gitignore merge section
...
func CheckGitConflicts(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Fix:     "Resolve conflicts manually: git checkout --ours or --theirs .beans/issues.jsonl",
	}
}
