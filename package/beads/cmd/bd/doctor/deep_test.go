...
// TestRunDeepValidation_NoBeadsDir verifies deep validation handles missing .beans directory
...
// TestRunDeepValidation_EmptyBeadsDir verifies deep validation with empty .beans directory
