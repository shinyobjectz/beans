...
// setupTestWorkspace creates a temporary directory with a .beans directory
...
// setupTestGitRepo creates a temporary git repository with a .beans directory
...
`)
	...
	t.Run("nonexistent_file", func(t *testing.T) {
		dir := setupTestWorkspace(t)
		jsonlPath := filepath.Join(dir, ".beans", "nonexistent.jsonl")
