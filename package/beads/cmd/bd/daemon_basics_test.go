...
// Note: The socketPath parameter is ignored; PID file is always in .beans directory
func TestGetPIDFileForSocket(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			dbPath:   "/home/user/.beans/issues.db",
			expected: "/home/user/.beans/daemon.pid",
		},
		{
			name:     "root beads directory",
			dbPath:   "/root/.beans/issues.db",
			expected: "/root/.beans/daemon.pid",
		},
		{
			name:     "nested project beads",
			dbPath:   "/home/user/projects/myapp/.beans/issues.db",
			expected: "/home/user/projects/myapp/.beans/daemon.pid",
		},
	}
