...
func getRepoKeyForPath(jsonlPath string) string {
	...
	// Remove trailing "/.beans/issues.jsonl" to get repo path
	const suffix = "/.beans/issues.jsonl"
...
This usually means:
  1. You copied a .beans directory from another repo (don't do this!)
...
Solutions:
  ...
  - If wrong database: rm -rf .beans && bd init
