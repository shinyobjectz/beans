...
func TestAgentStateWithRouting(t *testing.T) {
	...
	// Create town .beans directory
	townBeadsDir := filepath.Join(tmpDir, ".beans")
	if err := os.MkdirAll(townBeadsDir, 0755); err != nil {
		t.Fatalf("Failed to create town beads dir: %v", err)
	}

	// Create rig .beans directory
	rigBeadsDir := filepath.Join(tmpDir, "rig", ".beans")
	...
	// Create routes.jsonl in town .beans directory
