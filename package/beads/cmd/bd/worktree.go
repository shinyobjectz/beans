...
// .beans directory, and the daemon commits to whatever branch its working
...
func warnWorktreeDaemon(dbPathForWarning string) {
	...
	fmt.Fprintln(os.Stderr, "╠══════════════════════════════════════════════════════════════════════════╣")
	fmt.Fprintln(os.Stderr, "║ Git worktrees share the same .beans directory, which can cause the      ║")
...
// warnMultipleDatabases prints a warning if multiple .beans databases exist
