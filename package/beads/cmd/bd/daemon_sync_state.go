...
// Stored in .beans/sync-state.json (gitignored, local-only).
...
// LoadSyncState loads the sync state from .beans/sync-state.json.
...
// SaveSyncState saves the sync state to .beans/sync-state.json.
