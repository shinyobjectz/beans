...
# When true, bd will use .beans/issues.jsonl as the source of truth
...
// createReadme creates the README.md file in the .beans directory
...
Issues in Beads are:
- **Git-native**: Stored in ` + "`.beans/issues.jsonl`" + ` and synced like code
