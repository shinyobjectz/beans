...
// FindConfigYAMLPath finds the config.yaml file in .beans directory
// Walks up from CWD to find .beans/config.yaml
func FindConfigYAMLPath() (string, error) {
	...
	return "", fmt.Errorf("no .beans/config.yaml found in current directory or parents")
}
