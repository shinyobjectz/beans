...
func setupTestServer(t *testing.T) (*Server, *Client, func()) {
	...
	// Create .beans subdirectory so findDatabaseForCwd finds THIS database, not project's
...
// with .beans structure, but allows the caller to customize server/client setup.
